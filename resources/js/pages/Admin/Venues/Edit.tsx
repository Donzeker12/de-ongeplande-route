...
export default function VenuesEdit({ venue, types }: Props) {
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        opening_hours: (venue as any).opening_hours ?? '',
        prices: (venue as any).prices ?? '',
        highlights: (venue as any).highlights ?? '',
        accessibility_transport: (venue as any).accessibility_transport ?? '',
        accessibility_facilities: (venue as any).accessibility_facilities ?? '',
        city: venue.city ?? '',
