...
export default function SnippetsCreate({ outings }: SnippetsCreateProps) {
    ...
    return (
        <AdminLayout
            header={<h2 className="text-lg font-semibold text-white">Nieuwe Social Snippet</h2>}
        >
            <Head title="Nieuwe Snippet" />
                ...
                <div className="mx-auto max-w-3xl">
                    <form onSubmit={submit} className="space-y-6">
                        <div className="bg-[#16181f] border border-gray-800 rounded-xl p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    placeholder="Caption voor het bericht..."
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    placeholder="Extra teaser tekst..."
                                    className="w-full px-3 py-2 bg-[#0f1117] border border-gray-700 rounded-lg text-gray-300 placeholder-gray-600 focus:outline-none focus:border-emerald-500 transition resize-none"
                                />
                        ...
                        <div className="flex items-center justify-end gap-3">
                            ...
                            >
                                {processing ? 'Opslaan...' : 'Snippet aanmaken'}
                            </button>
                        </div>
                    </form>
                </div>
