...
export default function DiscoveryCreate({ outings, venues, defaultOutingId }: DiscoveryCreateProps) {
                        ...
                        {data.type === 'dier' && (
                            <div className="bg-[#16181f] border border-emerald-900/40 rounded-xl p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={dier.wetenschappelijke_naam || ''} onChange={(e) => setMeta('wetenschappelijke_naam', e.target.value)} placeholder="bijv. Heloderma suspectum suspectum" className={`${inputClass} italic placeholder-not-italic`} />
                                </div>
